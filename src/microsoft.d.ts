// biome-ignore lint/complexity/noBannedTypes: Microsoft...
declare type Window = {};
...
declare namespace Microsoft.Dynamics {
	// biome-ignore lint/complexity/noStaticOnlyClass: Microsoft...
	class NAV {
		/**
		...
		static InvokeExtensibilityMethod(
			methodName: string,
			// biome-ignore lint/suspicious/noExplicitAny: Microsoft...
			args?: any[],
			skipIfBusy?: boolean,
			callback?: () => void,
		): void;
